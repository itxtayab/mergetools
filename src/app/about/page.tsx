...
export const metadata: Metadata = {
    ...
    description: "Learn more about DevPik, the ultimate free online tools platform for developers and digital professionals.",
};
    ...
    return (
        <div className="mx-auto max-w-4xl space-y-8 pb-12">
            ...
            <div className="prose prose-slate max-w-none space-y-6 text-lg leading-relaxed">
                <p>
                    Welcome to <strong>DevPik</strong>, your go-to destination for free, high-quality digital tools.
